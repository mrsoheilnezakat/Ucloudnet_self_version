...
#     target_2x = F.interpolate(target, pred_sub2.shape[2:], mode='bilinear', align_corners=True)
#     target_4x = F.interpolate(target, pred_sub4.shape[2:], mode='bilinear', align_corners=True)
    
#     _1x_loss = F.binary_cross_entropy(paddle.nn.functional.sigmoid(pred), target)
#     _2x_loss = F.binary_cross_entropy(paddle.nn.functional.sigmoid(pred_sub2), target_2x)
#     _4x_loss = F.binary_cross_entropy(paddle.nn.functional.sigmoid(pred_sub4), target_4x)
